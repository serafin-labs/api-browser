...
module.exports = {
     ...
     */
    typescript(gulp, sourceDirectory, sourcePaths, tsConfigFile, outputDirectory, outputTypingsDirectory) {
        ...
        gulp.task('watch-typescript', function () {
            return gulp.watch(adaptPath(sourcePaths), { usePolling: true, awaitWriteFinish: true, alwaysStat: true },
                function () {
        ...
        gulp.task('build-typescript', function () {
            ...
            var tsStream = gulp.src(adaptPath(sourcePaths))
    ...
    test(gulp, jsTestsPath, coverageReportsDirectory) {
        gulp.task('test', function () {
            ...
            istanbul.on('close', function (data) {
                fs.stat(coverageReportsDirectory + '/coverage.json', (err) => {
                    if (!err) {
